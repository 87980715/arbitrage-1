...
//        int subLength = str.length() > 16 ? str.length()-16: 0;

        //切割为16位
//        return Long.parseLong(str.substring(subLength, str.length()));
        return result;
    }
